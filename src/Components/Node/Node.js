...
function TargetIcon() {
  return (
    <svg viewBox="45 0 428 510" version="1.1" fill="#000000" stroke="#000000">
...
function StartIcon() {
  return (
    <svg fill="#420863" viewBox="240 0 500 1030" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M419.3 264.8l-61.8 61.8L542.9 512 357.5 697.4l61.8 61.8L666.5 512z"></path></g>
    </svg>
  )
}
